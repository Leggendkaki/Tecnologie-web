...
{
print $cgi->header ( );
print '<script>alert("Il file inviato non risulta essere corretto"); location.href = "../submit.html";</script>';
exit;
}
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="it">
	...
	<div class="center"><h2>Portale aggiunto</h2></div>
